...
exports.Items = exports.PagePromise = exports.AbstractPage = void 0;
...
class AbstractPage {
    ...
    async getNextPage() {
        ...
        if (!nextOptions) {
            throw new error_1.LimrunError('No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.');
        }
...
class Items extends AbstractPage {
    constructor(client, response, body, options) {
    ...
    nextPageRequestOptions() {
        const items = this.getPaginatedItems();
        const isForwards = !(typeof this.options.query === 'object' && 'endingBefore' in (this.options.query || {}));
        if (isForwards) {
