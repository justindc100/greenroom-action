...
class ExecChildProcess {
    ...
    async kill() {
        ...
        try {
            await proxy_transport_1.nodeProxyTransport.fetch(`${this.options.apiUrl}/exec/${this.execId}/cancel`, {
                method: 'POST',
                headers: {
    ...
    async run(request) {
        ...
        let execRes;
        try {
            execRes = await proxy_transport_1.nodeProxyTransport.fetch(`${apiUrl}/exec`, {
                method: 'POST',
                headers: {
        ...
        return new Promise((resolve, reject) => {
            ...
            try {
                const eventSource = (0, eventsource_client_1.createEventSource)({
                    url: eventsUrl,
                    fetch: proxy_transport_1.nodeProxyTransport.fetch,
