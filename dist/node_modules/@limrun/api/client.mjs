...
import { AndroidInstances, } from "./resources/android-instances.mjs";
import { Assets } from "./resources/assets-helpers.mjs";
import { IosInstances, } from "./resources/ios-instances.mjs";
import { XcodeInstances, } from "./resources/xcode-instances-helpers.mjs";
...
export class Limrun {
    ...
    constructor({ baseURL = readEnv('LIMRUN_BASE_URL'), apiKey = readEnv('LIM_API_KEY') ?? null, ...opts } = {}) {
        ...
        this.androidInstances = new API.AndroidInstances(this);
        this.assets = new API.Assets(this);
        this.iosInstances = new API.IosInstances(this);
        this.xcodeInstances = new API.XcodeInstances(this);
        const options = {
            apiKey,
            ...opts,
        ...
        __classPrivateFieldSet(this, _Limrun_encoder, Opts.FallbackEncoder, "f");
...
Limrun.LimrunError = Errors.LimrunError;
Limrun.APIError = Errors.APIError;
Limrun.APIConnectionError = Errors.APIConnectionError;
Limrun.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Limrun.APIUserAbortError = Errors.APIUserAbortError;
Limrun.NotFoundError = Errors.NotFoundError;
Limrun.ConflictError = Errors.ConflictError;
Limrun.RateLimitError = Errors.RateLimitError;
Limrun.BadRequestError = Errors.BadRequestError;
Limrun.AuthenticationError = Errors.AuthenticationError;
Limrun.InternalServerError = Errors.InternalServerError;
Limrun.PermissionDeniedError = Errors.PermissionDeniedError;
Limrun.UnprocessableEntityError = Errors.UnprocessableEntityError;
Limrun.toFile = Uploads.toFile;
